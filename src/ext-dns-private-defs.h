 ...
 */
#ifndef __EXT_DNS_PRIVATE_DEFS_H__
#define __EXT_DNS_PRIVATE_DEFS_H__
 ...
 * resolution API. We can disable -ansi flag because we want ext-dns
 * to remain ANSI-C project so we have to include some static
...
#endif /* __EXT_DNS_PRIVATE_DEFS_H__ */
